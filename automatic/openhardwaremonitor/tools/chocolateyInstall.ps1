...
$StartMenuDir = (Get-ItemProperty -Path "HKLM:\Software\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders" `
                                  -Name "Common Programs") |
                                Select-Object -ExpandProperty "Common Programs"
...
Install-ChocolateyShortcut -ShortcutFilePath $shortcutFile `
                           -TargetPath $targetExe -WorkingDirectory $workingDir
